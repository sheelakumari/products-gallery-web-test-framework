...
public class FwComponent {		
	...
	/**
	 * Constructor for creating an object representing a component on a web page.
	 * 
	 * @param element The Selenium WebElement for this component.
	 */
	
	protected FwComponent(WebElement element) {
