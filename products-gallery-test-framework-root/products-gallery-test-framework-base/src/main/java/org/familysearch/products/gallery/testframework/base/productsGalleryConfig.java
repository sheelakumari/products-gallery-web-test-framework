...
public class productsGalleryConfig {
	
	public static Logger logger = org.apache.log4j.Logger.getLogger( productsGalleryConfig.class );
	...
	protected static productsGalleryConfig config = null; 
	 ...
	 */
	private productsGalleryConfig(String configFilePath) {
	...
	public static productsGalleryConfig getConfig(String customFilePath) {	
		...
		if ( config == null ) {
			...
			config = new productsGalleryConfig( customFilePath );
		}
		else
		{
